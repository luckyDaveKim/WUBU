...
class Bound:
    ...
    def check_bound_nth_previous(self, df: DataFrame, previous_nth: int) -> RuleResponse:
    ...
    def check_bound(self, row: Series) -> RuleResponse:
        if row.empty:
        ...
        if self.upper_bound:
            ...
            return RuleResponse.successOnly() if threshold_value <= value else RuleResponse.failureOnly()
        else:
            ...
            return RuleResponse.successOnly() if value <= threshold_value else RuleResponse.failureOnly()

...
# db_manger = DBManager()
#
# url = "https://finance.naver.com/marketindex/exchangeDegreeCountQuote.naver?marketindexCd=FX_USDKRW"
#
...
#     df = df[['announcement', 'rate']]
#     db_manger.insert_exchange_rate_announcement('2021-09-17', df)
